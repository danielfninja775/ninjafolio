...
<Image alt="" src="/Background5.jpg"  style={{marginTop:"1px"}}/>
...
<div className= { styles.services }>
  ...
  <div className= { styles.ProjectPics }>
    <Image alt=""  src="/pizza44.png"   className={styles.img4}/>
    <Image  alt="" src="/pizza33.png"   className={styles.img2}/>
    <Image alt="" src="/pizza22.png"   className={styles.img3}/>
    <Image alt="" src="/pizza11.png"  className={styles.img1} />
        ...
        <div className={ styles.ProjectPics1 }>
            ...
            <Image alt="" src="/cash66.png" width={300} height={300}  className={styles.img4}/>
           <Image alt="" src="/cash55.png" width={400} height={300}  className={styles.img2}/>
          <Image alt="" src="/cash77.png" width={400} height={300}  className={styles.img3}/>
          <Image alt="" src="/cash88.png" width={400} height={300} className={styles.img1} />
       </div>
       ...
       <div className= { styles.ProjectPics1 }>
   <Image alt="" src="/webpizza55.png" style={{marginLeft:"280px",marginTop:"-300px",
   marginBottom:"-60px"}}/>
   </div>
